...
public class angusActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        meals.add(new mealsList("Angus Beef"));
        meals.add(new mealsList("Angus Burger"));
        meals.add(new mealsList("Angus with mushroom"));
        meals.add(new mealsList("Angus with mushroom BBQ"));

        angusActivity.MyCustomAdapter myCustomAdapter=new angusActivity.MyCustomAdapter(meals);
        ListView ls=findViewById(R.id.listAngus);
