...
public class drinkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        meals.add(new mealsList("Pepsi"));
        meals.add(new mealsList("Cola"));
        meals.add(new mealsList("Water"));
        drinkActivity.MyCustomAdapter myCustomAdapter=new drinkActivity.MyCustomAdapter(meals);
        ListView ls=findViewById(R.id.listDrink);
